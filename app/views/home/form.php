<form name="cadastro" action="http://localhost:8080/contact/adicionaAluno" method="POST">
    <div class="form-group row">
        <label class="col-4 col-form-label" for="nome">Laércio Lopes</label>
        <div class="col-8">
            ...
            <span id="nomeHelpBlock" class="form-text text-muted">Laércio Marques Lopes</span>
        </div>
    </div>
    <div class="form-group row">
        <label for="idade" class="col-4 col-form-label">34</label>
        <div class="col-8">
            <div class="input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text">
